...
(function (Highcharts) {
    ...
    Highcharts.Chart.prototype.getDataRows = function () {
        ...
        each(this.series, function (series) {
            ...
            if (series.options.includeInCSVExport !== false && series.visible !== false && series.type !== 'trendline' && series.name !== 'Navigator') { // #55
                j = 0;
                while (j < valueCount) {
        ...
        // Add header row
        dataRows = [[options.xTitle || (xAxis.isDatetimeAxis ? 'DateTime' : 'Category')].concat(names)];
