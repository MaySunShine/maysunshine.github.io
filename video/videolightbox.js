    ...
    (function (a) {
        window.videoLightBox = function (c) {
            ...
            if (!a("#voverlay").length) {
                a(".videogallery").prepend("<div id='voverlay'><div id='vcontainer'></div></div>")
            }
            var o = true;
            ...
            if ( e==null) e = /^(.*\/)?[^\/]+\.swf\?.*url=([^&]+)&/.exec(g);
            if (swfobject.getFlashPlayerVersion().major || !e) {
               //a(".videogallery").prepend("flash version: " + swfobject.getFlashPlayerVersion().major + " e: " + e + "<br>");
               swfobject.createSWF({
                   data: g,
                   width: "100%",
                   height: "100%",
               ...
               e =  e[2]; //e = (e[1] || "") + e[2];
               //a(".videogallery").prepend("link video: " + e + "<br>");
               ...
               if (/Android/.test(navigator.userAgent)) {
                   ...
                   //a(".videogallery").prepend("android<br>");
               } else {
                   h.get(0).play();
                   //a(".videogallery").prepend("ios<br>");
               }
            }
